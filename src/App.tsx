        ...
        <section id="experience" className='flex flex-col gap-[64px] mt-[64px]'>
          ...
          <div className='flex flex-col gap-[36px] reveal reveal-left border-2 border-bright-blue rounded-lg p-3'>
            <div className='flex flex-row justify-between items-center'>
              ...
              <a href="https://github.com/colinlevine/open-game-agent" className='hidden sm:block px-4 py-2 font-serif text-xl rounded-lg bg-bright-blue text-white'>Learn More</a>
            </div>
          ...
          <div className='flex flex-col gap-[36px] reveal reveal-left border-2 border-bright-blue rounded-lg p-3'>
            <div className='flex flex-row justify-between items-center'>
              ...
              <a href="https://flashbackstudy.com" className='hidden sm:block px-4 py-2 font-serif text-xl rounded-lg bg-bright-blue text-white'>Learn More</a>
            </div>
          ...
          <div className='flex flex-col gap-[36px] reveal reveal-left border-2 border-bright-blue rounded-lg p-3'>
            <div className='flex flex-row justify-between items-center'>
              ...
              <a href="https://github.com/colinlevine/music-generation-model" className='hidden sm:block px-4 py-2 font-serif text-xl rounded-lg bg-bright-blue text-white'>Listen to Songs</a>
            </div>
